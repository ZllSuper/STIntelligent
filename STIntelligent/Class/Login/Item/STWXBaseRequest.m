...
- (instancetype) init
{
    if (self = [super init])
    {
        ...
        if (!manager)
        {
            manager = [BXHNetWorkPartManager mangerWithHost:@"https://api.weixin.qq.com/sns" andsessionConfiguration:[NSURLSessionConfiguration defaultSessionConfiguration] valueKey:WXRequestKey];
