...
- (instancetype)initWithTitle:(NSString *)title propertyName:(NSString *)properTyName
{
    if (self = [super init])
    {
        self.title = title;
...
- (void)updateUserNickName
{
    ...
    PCEditUserNameRequest *infoRequest = [[PCEditUserNameRequest alloc] init];
    infoRequest.cUserId = KAccountInfo.userId;
    infoRequest.nickName = self.textFiled.text;
    ...
    [infoRequest requestWithSuccess:^(BXHBaseRequest *request) {
        ...
        {
            KAccountInfo.name = weakSelf.textFiled.text;
...
- (UITextField *)textFiled
{
    if (!_textFiled)
    {
        ...
        _textFiled.text = CheckString([KAccountInfo valueForKey:self.propertyName]);
    }
    return _textFiled;
}
