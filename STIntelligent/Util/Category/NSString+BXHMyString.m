...
{
    if (sourceStr && [sourceStr isKindOfClass:[NSString class]] && sourceStr.length > 0 && ![sourceStr isEqualToString:@"(null)"] && ![sourceStr isEqualToString:@"<null>"] && ![sourceStr isEqualToString:@"0"])
    {
        return NO;
    }
    else
