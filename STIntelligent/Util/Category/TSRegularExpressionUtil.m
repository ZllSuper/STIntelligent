...
{
    NSString *phoneRegex = @"^1(7[0-9]|3[0-9]|5[0-35-9]|8[0-35-9])\\d{8}$";//@"^((13[0-9])|(15[^4,\\D])|(18[0,0-9]))\\d{8}$";
...
+ (BOOL)urlValidation:(NSString *)string
{
    ...
    NSPredicate *passWordPredicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@",regulaStr];
